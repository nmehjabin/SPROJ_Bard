...
output_dir = Path.home()/"Desktop/sproj'24-'25/ecmmodel(workingversion)/ECM_model/ecm/results"
...
boxplot_path = os.path.join(str(output_dir), "anova_boxplot_enhanced.png")
...
if p_val < alpha:
    ...
    plt.tight_layout()
    custom_tukey_path = os.path.join(str(output_dir), "custom_tukey_plot.png")
